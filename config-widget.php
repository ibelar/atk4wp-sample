...
$config['widget']['atk4wp-event'] = [
	'uses'         =>  __NAMESPACE__ . '\Widget\Event',
	'title'         => _('Atk4wp Event'),
	'widget_ops'    => ['classname' =>'at4wp-wdg', 'description' => 'Display Atk4wp event\'s name'],
	'fields'        => [ 'title' => ['type' => 'line', 'caption' => _('Title'), 'default' => _('Last Event')],
	                     'count' => ['type' => 'number','caption' => _('Number of events'), 'default' => 2 ]
						]
];
